...
CREATE TABLE IF NOT EXISTS process (
    ...
    category VARCHAR(20) COMMENT '工序类别：EXCAVATION/HAULING/SUPPORT/SHOTCRETE 等，冗余自工序字典',
    deleted TINYINT DEFAULT 0 COMMENT '删除标志：0-未删除，1-已删除',
    create_time DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    update_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE IF NOT EXISTS process_catalog (
    ...
    category VARCHAR(20) COMMENT '工序类别：EXCAVATION-开挖/HAULING-出渣/SUPPORT-立架/SHOTCRETE-喷砼等',

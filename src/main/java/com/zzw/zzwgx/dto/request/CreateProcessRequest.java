...
public class CreateProcessRequest {
    ...
    @Schema(description = "工序名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "钻孔")
    @NotBlank(message = "工序名称不能为空")
    private String name;
    
    @Schema(description = "控制时长标准（分钟）", requiredMode = Schema.RequiredMode.REQUIRED, example = "120")
